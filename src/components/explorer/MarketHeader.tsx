import { Database, ShieldCheck, Clock, Zap, Pin } from "lucide-react";
  ...
  return (
            <div className="max-w-[1600px] mx-auto w-full flex flex-col gap-3 px-1 pt-1 pb-2">
              ...
              <section aria-labelledby="market-summary" className="flex flex-col gap-2.5">
                <div className="rounded-2xl border border-slate-200/50 bg-white/80 p-3 sm:p-3.5 shadow-none dark:border-slate-800/60 dark:bg-slate-900/50">
